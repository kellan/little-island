...
*Superseded as the working reference by [GOBLINS.md](GOBLINS.md)*, which reads this fork,
[LINEAGE.md](LINEAGE.md) and the main brief together on the assumption that the goblin fork
is taken. This document keeps the original reasoning.
